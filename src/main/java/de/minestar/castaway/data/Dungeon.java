...
public class Dungeon {
    ...
    public void playerFinished(PlayerData playerData) {
        ...
        if (this.hasOption(DungeonOption.DISABLE_SAVE_ON_FINISH)) {
            ...
            // send info
            PlayerUtils.sendMessage(player, ChatColor.DARK_AQUA, "------------------------------");
            PlayerUtils.sendSuccess(player, "Herzlich Gl�ckwunsch! Du hast den Dungeon '" + this.getName() + "' erfolgreich beendet!");
            PlayerUtils.sendSuccess(player, "Du hast daf�r " + formatTime(time) + " ben�tigt");
