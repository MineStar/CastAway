...
public class DeathInDungeonStat implements Statistic {

    private String playerName;
    private int dungeonID;
    private Timestamp date;

    public DeathInDungeonStat() {
        // EMPTY CONSTRUCTION FOR REFLECTION ACCESS
    }

    public DeathInDungeonStat(String playerName, int dungeonID) {
