...
public class ClearInvOnDeathBlock extends AbstractActionBlock {

    public ClearInvOnDeathBlock(BlockVector vector, Dungeon dungeon) {
        super(vector, dungeon, ActionBlockType.CLEAR_INV_ON_DEATH);
