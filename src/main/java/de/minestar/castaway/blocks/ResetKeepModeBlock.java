...
public class ResetKeepModeBlock extends AbstractActionBlock {

    public ResetKeepModeBlock(BlockVector vector, Dungeon dungeon) {
        super(vector, dungeon, ActionBlockType.RESET_KEEP_DUNGEON_MODE);
    ...
    public boolean execute(Player player, PlayerData data) {
        ...
        data.setKeepDungeonModeOnDeath(false);
        return false;
    }
}
