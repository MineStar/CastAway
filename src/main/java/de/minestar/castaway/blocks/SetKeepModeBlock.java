...
public class SetKeepModeBlock extends AbstractActionBlock {

    public SetKeepModeBlock(BlockVector vector, Dungeon dungeon) {
        super(vector, dungeon, ActionBlockType.KEEP_DUNGEON_MODE);
    ...
    public boolean execute(Player player, PlayerData data) {
        ...
        data.setKeepDungeonModeOnDeath(true);
        return false;
    }
}
